  ...
  return (
    <div className="container mx-auto mt-8 px-4 sm:px-6 md:px-8 ">
      <div className="mt-4 flex justify-end">
        <button
          className="active:bg-blue-500 text-white text-2xl bg-[#E0E0E0] px-4 py-2 rounded-full mx-5 relative -left-44 lg:relative lg:-top-16 lg:-left-20 md:relative md:-top-16 md:left-6"
        ...
        <button
          className="active:bg-blue-500 text-white text-2xl bg-[#E0E0E0] px-4 py-2 rounded-full mx-5  md:relative md:-top-16"
      ...
      <div className="flex flex-wrap overflow-x-hidden ">
        {cardsData.slice(startIndex, startIndex + 3).map((card) => (
          <div key={card.id} className="w-full sm:w-1/2 md:w-1/3 p-4 ">
            <div className="border border-gray-300 rounded shadow-md bg-[#CFEAFF] p-10">
